...
public class SimPlotVL extends VerticalLayout {
	...
	public SimPlotVL(SimConfigArray plotConfig) {
		...
		gl.addComponents(SimConfigToComponent.convert(plotConfig.get("FontSize"), null), fontCBVL, SimConfigToComponent.convert(plotConfig.get("LineThickness"), null), SimConfigToComponent.convert(plotConfig.get("ImageResolution"), null),SimConfigToComponent.convert(plotConfig.get("ImageSize-Small"), null),SimConfigToComponent.convert(plotConfig.get("ImageSize-Big"), null));
