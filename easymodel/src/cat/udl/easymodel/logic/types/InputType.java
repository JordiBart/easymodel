...
public enum InputType {
	STRING(0), MATHEXPRESSION(1), DECIMAL(2), CHECKBOX(3), SLIDER(4),ARRAYCHECKBOX(5);
    private int value;
    
    public static final String mathAtomRegex = "(\\s*\\-?\\(*\\-?(\\d+(\\.\\d+)?)\\)*\\s*)";
	public static final String simpleMathExpressionRegex = "^"+mathAtomRegex+"((\\+|\\-|\\*|\\^|\\s+|/)"+mathAtomRegex+")*$";
