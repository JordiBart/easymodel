...
public class SimConfig {
	...
	private void initConfig() {
		...
		commonPlot.add(new SimConfigEntry("ImageResolution", new SimConfigSlider("300", "72", "2000", 1), InputType.SLIDER, "Image Resolution", "Image resolution in DPI"));
		commonPlot.add(new SimConfigEntry("ImageSize-Small", new SimConfigSlider("500", "300", "1000", 1), InputType.SLIDER, "Image Width (pixels)", "Image width of plots displayed in results layout"));
		commonPlot.add(new SimConfigEntry("ImageSize-Big", new SimConfigSlider("1500", "1000", "3000", 1), InputType.SLIDER, "Large Image Width (pixels)", "Image width of enlarged plots (left-click on standard plot image to enlarge)"));
	}
