...
public class SimParamScanConfig {
	private ArrayList<ParamScanEntry> parameters = new ArrayList<ParamScanEntry>();
	private ArrayList<ParamScanEntry> independentVars = new ArrayList<ParamScanEntry>();

	SimParamScanConfig() {
	}

	SimParamScanConfig(SimParamScanConfig from) {
		parameters.addAll(from.getParameters());
		independentVars.addAll(from.getIndependentVars());
	}
