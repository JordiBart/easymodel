...
import cat.udl.easymodel.thread.SimulationThreadManagerThread;
...
//						UI.getCurrent().addWindow(importSBMLW);
	...
	public void showResults() {
		...
		conPanel.setContent(resultsVL);
		// launch sim threads
		if (sessionData.getSimulationThread() == null)
			new SimulationThreadManagerThread(sessionData, resultsVL).start();
		else
