...
public class ParamScanEntry {
	...
	public ParamScanEntry(ParamScanEntry from, Model toModel) {
		this.copyFrom(from);
		if (reaction!=null) {
			reaction=toModel.getReactionByIdJava(reaction.getIdJava());
		}
	}
	...
	public void copyFrom(ParamScanEntry from) {
		...
		isArrayParameter=from.isArrayParameter;
		speciesType=from.speciesType;
		parameterSpeciesName=from.parameterSpeciesName;
		reaction = from.reaction; //copy reference is ok
