...
public class FormulaUtils {
	public static final String genericFormulaPrefix = "EZM_KE_";
	public static final String realNumberRegex = "(\\d+(\\.\\d+)?)";
	public static final String defaultFormulaNamePrefix = "K";
