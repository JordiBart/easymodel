...
public class CheckSystemJob extends MathJob {
    public CheckSystemJob() {
        super();
    }
    ...
    public String call() throws Exception {
        ...
        P.d("Start CheckSystemJob "+this.getJobId());
        try {
            this.callable = new CheckSystemJobCallable(this);
...
class CheckSystemJobCallable implements Callable<String> {
    private CheckSystemJob job;

    public CheckSystemJobCallable(CheckSystemJob job) {
        this.job = job;
    }
